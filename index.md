...
#### Литература и ссылки по теме {#sources}
...
### Педагогическая практика {#ped-practice}
...
Текст лекции должен содержать около 3000--4000 слов (из расчета 100
...
Длительность лекции практиканта --- 30--40 минут.  Исходя из этого
